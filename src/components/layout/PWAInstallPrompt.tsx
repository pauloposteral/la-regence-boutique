    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-16 lg:bottom-4 left-4 right-4 lg:left-auto lg:right-4 lg:max-w-sm z-50 bg-card border border-border rounded-xl shadow-xl p-4"
        >
          <button onClick={dismiss} className="absolute top-2 right-2 p-1 hover:bg-muted rounded">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-display text-sm font-semibold">Instalar La Régence</p>
