        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className="bg-card p-8 rounded-lg border border-border relative hover:border-gold/25 transition-all duration-500 group"
            >
              ...
              <p className="font-body text-foreground/70 italic leading-relaxed mb-6 text-sm">
                "{t.text}"
              </p>
              <div className="border-t border-border pt-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground font-body">{t.role} · {t.coffee}</p>
                </div>
              </div>
            </motion.div>
          ))}
